package tfar.mineanything.entity.ai;
...
public class CloneFollowOwnerGoal extends Goal {
    ...
    public CloneFollowOwnerGoal(ClonePlayerEntity pTamable, double pSpeedModifier, float pStartDistance, float pStopDistance, boolean pCanFly) {
        this.clonePlayer = pTamable;
    ...
    private boolean canTeleportTo(BlockPos pPos) {
        ...
        if (blockpathtypes != BlockPathTypes.WALKABLE) {
            ...
            if (!this.canFly && blockstate.getBlock() instanceof LeavesBlock) {
                ...
                BlockPos blockpos = pPos.subtract(this.clonePlayer.blockPosition());
                return this.level.noCollision(this.clonePlayer, this.clonePlayer.getBoundingBox().move(blockpos));
            }
        }
    }

    private int randomIntInclusive(int pMin, int pMax) {
        return this.clonePlayer.getRandom().nextInt(pMax - pMin + 1) + pMin;
    }
}
