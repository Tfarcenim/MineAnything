...
public class ModEntities {
    ...
    public static final EntityType<PrimedLavaTnt> TNT = EntityType.Builder.<PrimedLavaTnt>of(PrimedLavaTnt::new, MobCategory.MISC).fireImmune().sized(0.98F, 0.98F).clientTrackingRange(10).updateInterval(10).build("");
