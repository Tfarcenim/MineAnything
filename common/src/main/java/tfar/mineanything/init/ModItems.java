...
import tfar.mineanything.item.ZombiePickaxeItem;
...
public class ModItems {
    ...
    public static final Item ZOMBIE_MINER = new ZombiePickaxeItem(Tiers.NETHERITE, 3, -2.4F, new Item.Properties().fireResistant());
